...
ggplot(data = diamonds) + 
  stat_summary(mapping = aes(x=cut, y=depth), fun.ymin = min, fun.ymax = max, fun.y = mean)
...
# (geom_bin2d)
# What happens when you make the x and y channels scale logarithmically? linear
ggplot(data = diamonds) +
